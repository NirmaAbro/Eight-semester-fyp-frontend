...
//   // / Track whether the form is completely filled
...
//   const handleuserProfilepagesavedata = async () => {
//     const requestBody = {
//       name,
//       age,
//       gender,
...
//           </div>
//           <div>
//             <label className="block text-lg">Height (Feet)</label>
//             <input
//               type="number"
//               name="height"
...
//             {/* Conditionally show Create Profile button */}
//             {isFormComplete && (
//               <button
//                 type="button"
//                 onClick={handleuserProfilepagesavedata}
//                 className="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700"
//               >
//                 Create Profile
//               </button>
...
function Getstarted() {
  ...
  const handleuserProfilepagesavedata = async () => {
    ...
    // Show success toast after saving the profile
  ...
  const consolecheck = () => {
    console.log("get diet plane button clicked ");
  };
