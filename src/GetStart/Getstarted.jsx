...
// new separate code of diet plane list
...
function Getstarted() {
  ...
  return (
    <>
      ...
      {dietPlans.length > 0 && (
        <div className="mt-6 space-y-4 w-full m-4 mx-auto p-6 bg-white shadow-md rounded-lg">
          <h2 className="text-2xl font-bold mb-4">Generated Diet Plans</h2>
          <DietPlanList
            dietPlans={dietPlans}
